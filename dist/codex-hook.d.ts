...
export declare function runLspPostToolUseHook(input: CodexPostToolUseInput, runDiagnostics?: DiagnosticsRunner, missingServerNotices?: MissingServerNoticeStore): Promise<string>;
